...
const BASIM_WHATSAPP = "962793333798";
const TEAM_WHATSAPP:Record<string,string> = { "باسم":BASIM_WHATSAPP, "خالد":"962770977777", "شادي":"962799313108", "أيمن":"962788870444" };
const waLink = (message:string, phone = BASIM_WHATSAPP) => `https://wa.me/${phone}?text=${encodeURIComponent(message)}`;
