...
const ALLOWED_KEYS = ["TEAM_CHAT_ENABLED", "TEAM_CHAT_SHARED_KEY", "TEAM_CHAT_CONTACTS_JSON", "TEAM_CHAT_GROUP_IDS_JSON", "GROQ_API_KEY", "GROQ_MODEL",
  "WHATSAPP_LOGIN_ENABLED", "WHATSAPP_LOGIN_SECRET", "WHATSAPP_LOGIN_DATABASE", "WHATSAPP_LOGIN_ORIGIN", "SECRETARY_ENABLED", "SECRETARY_WEB_ENABLED", "SECRETARY_VOICE_ENABLED"];
